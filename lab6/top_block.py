...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.amplitude_input = amplitude_input = 0.1
        ...
        _amplitude_input_sizer = wx.BoxSizer(wx.VERTICAL)
        self._amplitude_input_text_box = forms.text_box(
        	parent=self.GetWin(),
        	sizer=_amplitude_input_sizer,
        	value=self.amplitude_input,
        	callback=self.set_amplitude_input,
        	label='amplitude_input',
        	converter=forms.float_converter(),
        	proportion=0,
        )
        self._amplitude_input_slider = forms.slider(
        	parent=self.GetWin(),
        	sizer=_amplitude_input_sizer,
        	value=self.amplitude_input,
        	callback=self.set_amplitude_input,
        ...
        self.Add(_amplitude_input_sizer)
        ...
        self.blocks_multiply_const_vxx_0_0_0 = blocks.multiply_const_vff((0.1, ))
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vff((20, ))
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, "/home/arktheshadow/ARK-Linux/Programming/CommunicationLab/EE340L-Communication-Lab/lab6/Input.bin", True)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 6000, amplitude_input, 0)
    ...
    def get_amplitude_input(self):
        return self.amplitude_input
